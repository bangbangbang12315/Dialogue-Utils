...
def load_data(raw_data):
    ...
    resp_userID = []
    phase = 'train'
    with open(os.path.join(raw_data, 'post.'+phase), 'r') as fpost, open(os.path.join(raw_data, 'resp.'+phase), 'r') as fresp, open(os.path.join(raw_data, 'extra', 'resp_id.'+phase), 'r') as fuser:
